...
def make_index(ms, words):
    '''Given a manuscrript and list of entries, writes an index'''
...
# careful: maybee unecessary but line above and a line below both need tidy words slightly differently
